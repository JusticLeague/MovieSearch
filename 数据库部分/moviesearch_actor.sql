...
CREATE TABLE `actor` (
  ...
  `actor_sex` varchar(5) DEFAULT NULL,
...
INSERT INTO `actor` VALUES (1,'成龙','man',40,'china',NULL),(2,'陈坤','man',30,'china',NULL),(3,'陈道明','man',42,'china',NULL),(4,'安妮海瑟薇','woman',28,'USA',NULL);
